       ...
       <!--  <script>
        ...
        <script type="text/javascript">
        	...
        	function Add(){
        	 ...
        	 <%
        	 		NewsClass xw=(NewsClass)request.getAttribute("news");
        	  %>
        	/* 修改 */
        	function News_upd(id){
        		...
        		var data=$("#form").serialize();
              		  $.post("/JiaJu/NewsClassServlet?method=update&id=<%=xw.getNewsClassId()%>",data,
              		  function(res){
                        		if(res.success){
                        			alert(res.message);
                        		}else{
            ...
            <form class="layui-form" onsubmit="return Test(this)" id="form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="newsClass" name="newsClass" required="" lay-verify="required" value="<%=xw.getNewsClassName() %>"
                ...
                <div class="layui-form-item">
                    ...
                    <a class="layui-btn" lay-filter="add" lay-submit="" onclick="News_upd(<%=xw.getNewsClassId()%>)">
                        修改
                    </a>
                </div>
            </form>
