...
<section class="pro-list">
    ...
    <aside class="pro-leftsidebar">
        <ul>
            <li>
                <a>产品搜索</a><!-- <li><a><input type="text"  class="pro-search"><a class="pro-search-btn">搜索</a></a></li> -->
                <ul id="pro-search">
            ...
            <li>
                ...
                <ul id="pro-category">
                <%
        	List<ProductClass> fenlei=(List<ProductClass>)request.getAttribute("fenlei");//获取产品分类
        		if(fenlei!=null){
    ...
    <aside class="pro-rightsidebar">
     <%               
 				List<product> chanpin=(List<product>)request.getAttribute("cp");//前台显示产品
                		if(chanpin!=null){
                 %>
        <header>
                    <p></p>
        ...
        <%for(int i=0;i<chanpin.size();i++){ %>
            <li>
                <a href="ProductInfoSer?id=<%=chanpin.get(i).getProductId()%>">
                    <div class="img-box" style="height:230px;">
                        <img src="<%=chanpin.get(i).getUrl()%>">
