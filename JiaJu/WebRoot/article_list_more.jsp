...
<div>
    ...
    <section class="article-content">
        <ul id="FenYe">
        <%
        		List<News> news=(List<News>)request.getAttribute("news");//接收ser传过来的值
        			if(news!=null){
         ...
         %>
            <li>
                <div class="article-date">
                    <strong><%=i+1 %></strong>
                    <p><%=news.get(i).getNewsdate() %></p>
                </div>
                <div class="article-info">
                    <a href="NewsInfoSer?id=<%=news.get(i).getNewsId()%>">
                        <h3><%=news.get(i).getTitle() %></h3>
                        <p><%=news.get(i).getInfo() %></p>
                    </a>
                </div>
            </li>
            	<%}
